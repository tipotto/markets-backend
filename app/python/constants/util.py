...
STATUS_ERROR = 'error'
SLACK_TOKEN_REFRESH_NOTIFICATION_URL = 'https://asia-northeast1-markets-jp.cloudfunctions.net/slack-token-refresh-notification'
DEV_PYTHON_LOG_DIR_PATH = '/home/vagrant/workspace/markets/backend/app/python/log'
PROD_PYTHON_LOG_DIR_PATH = '/var/www/api/app/python/log'
